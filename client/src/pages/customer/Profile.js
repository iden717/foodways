...
const Profile = () => {
  ...
  const payload = {
    ...
    cache: "historyTransaction",
  };

  const historyTransaction = Crud(payload);
  const historyCustomer = historyTransaction?.data?.data?.data?.transaction;

  console.log("history", historyCustomer);
